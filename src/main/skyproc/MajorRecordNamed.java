 ...
 */
public abstract class MajorRecordNamed extends MajorRecord implements
		Serializable {

	static final SubPrototype namedProto = new SubPrototype(
	 ...
	 *
	 * @param in
	 *            The string to set the in-game name to.
	 */

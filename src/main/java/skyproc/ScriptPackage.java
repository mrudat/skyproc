...
public class ScriptPackage extends SubRecord implements Serializable {
	...
	if (logging()) {
	    logMod(srcMod, toString(), "Importing VMAD record with "
		    + scriptCount + " scripts.  Version: " + version
		    + ", unknown: " + unknown);
	}
     ...
     *
     * @param scriptName
     *            Adds an empty script with the given name.
     */
     ...
     *
     * @param scriptName
     *            Script name to remove, if present.
     */

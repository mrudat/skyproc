...
public class FormID implements Comparable, Serializable {
	 ...
	 * @param master
	 *            String containing the mod it originates from. Eg. "Skyrim.esm"
	 */
	 ...
	 *            immediately by the plugin it originates from. eg
	 *            "000123Skyrim.esm"
	 */
	 ...
	 *            forms: "000123", "00 01 23", "0x00 0x01 0x23".
	 * @param master
	 *            The mod from which this formID originates.
	 */
	 ...
	 *
	 * @param id
	 *            Byte array (usually size 3), which contains FormID bytes.
	 * @param master
	 *            The mod from which this formID originates.
	 */
	 ...
	 *
	 * @param id
	 *            An int array containing the last 6 digits of the FormID.
	 * @param master
	 *            The modname from which this formID originates.
	 */
	 ...
	 *
	 * @param s
	 *            String array of length 2. First index must be length 6.

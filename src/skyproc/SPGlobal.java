...
public class SPGlobal {
	...
	/**
	 * Path to the Data/ folder to look for plugins to import/export.<br>
	 * <br>
	 * By default, this is set to "../../", meaning the patch has to be in a
	 ...
	 *
	 * @param patch
	 *            Mod to set as the global patch.
	 */
	 ...
	 * you to print messages to them.<br>
	 * Do this step early in your program.
	 *
	 * @param path
	 *            The path to create the "SkyProcDebug/" folder.
	 */
	...
	/**
	 * Logs a message to the Debug Overview file. <br>
	 * Use this for major program "milestones".
	 *
	 * @param header
	 * @param print
	 */
	 ...
	 *
	 * @param e
	 *            The enum you defined to symbolize the "key" to the special
	 *            log.
	 * @param header
	 * @param print
	 */
	 ...
	 *
	 * @param e
	 *            Any enum you define to symbolize the "key" to the special log.
	 * @param logName
	 */
	...
	/**
	 * Print messages concerning the merging of two plugins.<br>
	 * Prints to the sync log<br>
	 */

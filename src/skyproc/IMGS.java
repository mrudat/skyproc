...
public class IMGS extends MajorRecord {
	...
	static final SubPrototype IMGSproto = new SubPrototype(
	...
	static final class HNAM extends SubRecord {
		...
		final void parseData(LImport in, Mod srcMod) throws BadRecord,
			...
			if (logging()) {
				...
				logMod(srcMod, "", "  " + "Eye Adapt Speed: " + eyeAdaptSpeed
						+ ", Bloom Radius: " + bloomRadius);
				logMod(srcMod, "", "  " + "Bloom Threshold: " + bloomThreshold
						+ ", Bloom Scale: " + bloomScale + ", Target Lum #1: "
						+ targetLum1);
				logMod(srcMod, "", "  " + "Target Lum #2: " + targetLum2
						+ ", Sunlight Scale: " + sunlightScale);
				logMod(srcMod, "", "  " + "Sky Scale: " + skyScale
						+ ", Eye Adapt Strength: " + eyeAdaptStrength);
			}
	...
	static final class CNAM extends SubRecord {
		...
		void parseData(LImport in, Mod srcMod) throws BadRecord,
			...
			if (logging()) {
				...
				logMod(srcMod, "", "  " + "Saturation: " + saturation

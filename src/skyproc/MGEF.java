...
public class MGEF extends MajorRecordDescription {
	...
	static final SubPrototype MGEFproto = new SubPrototype(
		...
		protected void addRecords() {
			...
			add(new DATA());
			add(new SNDD());
			SubStringPointer dnam = new SubStringPointer("DNAM",
	...
	static class DATA extends SubRecord {
		...
		void parseData(LImport in, Mod srcMod) throws BadRecord,
			...
			if (SPGlobal.logging()) {
				...
				logMod(srcMod, "", "  Script AI Data Score: "
						+ scriptAIDataScore);
				logMod(srcMod, "", "  Script AI Data Delay Time: "

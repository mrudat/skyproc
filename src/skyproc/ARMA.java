...
public class ARMA extends MajorRecord {
	 ...
	 *
	 * @param path
	 *            Path of the .nif file to assign.
	 * @param gender
	 *            The gender to assign this model path to.
	 * @param perspective
	 *            Perspective to assign this model path to.
	 */
	 ...
	 *
	 * @param gender
	 *            The gender of the desired model path to query.
	 * @param perspective
	 *            The perspective of the model path to query.
	 ...
	 * @param perspective
	 *            Perspective of the pack to compare
	 * @return true if:<br>

...
public class LIGH extends MajorRecordNamed {
	...
	static final SubPrototype LIGHproto = new SubPrototype(
	...
	static class DATA extends SubRecord {
		...
		public boolean equals(Object obj) {
			...
			if (Float.floatToIntBits(this.fov) != Float
					.floatToIntBits(other.fov)) {
				return false;
			}
			if (Float.floatToIntBits(this.nearclip) != Float
					.floatToIntBits(other.nearclip)) {
				return false;
			}
			if (Float.floatToIntBits(this.period) != Float
					.floatToIntBits(other.period)) {
				return false;
			}
			...
			if (Float.floatToIntBits(this.movement) != Float
					.floatToIntBits(other.movement)) {
				return false;
			}
			if (this.value != other.value) {
				return false;
			}
			if (Float.floatToIntBits(this.weight) != Float

...
public class SPDatabase implements Iterable<Mod> {
	 ...
	 *
	 * @param listing
	 *            ModListing object to query for.
	...
	static public void exportModList(String path) throws IOException {
		File modListTmp = new File(SPGlobal.pathToInternalFiles
				+ "Last Modlist Temp.txt");
	...
	/**
	 *
	 * @return ArrayList of mod names + date modified data separated by the date
	 *         delimiter.
	 */
	 ...
	 * version in the latest mod in the load order will be returned. <br>
	 * NOTE: it is recommended you use the version that only searches in
	 * specific GRUPs for speed reasons.
	 *
	 * @param query
	 ...
	 *
	 * @param modSet
	 *            Set of mods to add into the database.
	 */

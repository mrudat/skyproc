...
/**
 * Leveled List. A list of entries used for spawnpoints when choosing which
 * actor to spawn. Each entry contains a FormID of an actor, a level, and a
 * count to spawn.
 * 
...
public class LVLN extends LeveledRecord {
	...
	static final SubPrototype LVLNproto = new SubPrototype(
	...
	public String print() {
		super.print();
		logMod(srcMod, getTypes().toString(), "Chance none: " + getChanceNone()
				+ ", Flags: " + subRecords.getSubFlag("LVLF").print());
	 ...
	 * @deprecated use getModelData()
	 * @param in
	 *            String to set the LVLN model path to.
	 */
